    ...
    return (
        <div className="min-h-screen bg-slate-50 pt-20 pb-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div>
                            <div className="flex items-center gap-3 mb-2">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-500 font-medium text-sm">Find your perfect home away from home.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="flex gap-3">
                            {[
                                ...
                                <div key={i} className="bg-white px-4 py-3 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-3">
                ...
                {/* Tab Navigation */}
                <div className="bg-white rounded-2xl p-1.5 border border-slate-100 shadow-sm mb-8 flex gap-1 overflow-x-auto">
                    {tabs.map((tab) => (
                        <button
                            key={tab.id}
                        ...
                        >
                            ...
                            <span>{tab.label}</span>
                            {tab.count !== undefined && (
                                <span className={`text-[10px] font-black px-2 py-0.5 rounded-full ${activeTab === tab.id ? 'bg-white/20 text-white' : 'bg-slate-100 text-slate-400'
                                    }`}>
                                    {tab.count}
                                </span>
                            )}
                    ...
                    <div className="animate-fade-in">
                        ...
                        {filteredListings.length > 0 ? (
                            ...
                            <div className="bg-white rounded-[2.5rem] p-20 text-center border border-dashed border-slate-200">
                                ...
                                <p className="text-slate-500 font-medium mb-6">Try adjusting your filters or search.</p>
                                <button
                    ...
                    <div className="animate-fade-in">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                            <div>
                                ...
                                <p className="text-slate-500 font-medium text-sm">Post your requirement and connect with compatible students.</p>
                            </div>
                            <button
                            ...
                            <div className="bg-white rounded-3xl border border-slate-100 shadow-sm p-8 mb-8">
                                ...
                                {roommateSuccess ? (
                                    <div className="flex flex-col items-center py-10 text-center">
                                        ...
                                        <p className="text-slate-500 text-sm mt-1">Your requirement is pending admin verification. It will go live once approved.</p>
                                    </div>
                                ) : (
                        ...
                        {roommateLoading ? (
                                        ...
                                        <div className="bg-gradient-to-br from-primary-50 to-indigo-50 p-5 border-b border-slate-100">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    {req.college && (
                                                        <p className="text-xs text-slate-500 font-medium">{req.college}</p>
                                                    )}
                                                </div>
                                        ...
                                        <div className="p-5 space-y-3">
                                            ...
                                            {req.budget && (
                                                <div className="flex items-center gap-2 text-sm font-medium text-slate-600">
                                                    ...
                                                    <span>Budget: <span className="font-bold text-slate-800">₹{Number(req.budget).toLocaleString()}/mo</span></span>
                                                </div>
                                            )}
                                            {req.move_in_date && (
                                                <div className="flex items-center gap-2 text-sm font-medium text-slate-600">
                                                    <Calendar size={14} className="text-amber-400 shrink-0" />
                                                    <span>Move-in: <span className="font-bold text-slate-800">{new Date(req.move_in_date).toLocaleDateString('en-IN', { day: 'numeric', month: 'short', year: 'numeric' })}</span></span>
                                                </div>
                                            )}
                                            {req.description && (
                                                <p className="text-sm text-slate-500 font-medium leading-relaxed line-clamp-2 pt-1">
                                                    {req.description}
                                                </p>
                                            )}
                                        </div>
                            ...
                            <div className="bg-white rounded-[2.5rem] p-20 text-center border border-dashed border-slate-200">
                                ...
                                <p className="text-slate-500 font-medium mb-6">Be the first to post your requirement!</p>
                    ...
                    <div className="animate-fade-in">
                        <div className="flex items-center justify-between mb-6">
                            <div>
                                ...
                                <p className="text-slate-500 font-medium text-sm">Your bookmarked stays for easy access.</p>
                            </div>
                        ...
                        {savedListings.length > 0 ? (
                            ...
                            <div className="bg-white rounded-[2.5rem] p-20 text-center border border-dashed border-slate-200">
                                ...
                                <p className="text-slate-500 font-medium mb-6">Browse listings and tap the heart to save them here.</p>
